...
const ProductPage3 = () => {
  ...
  const product = {
    name: 'Kaareen Performance Shoes',
    ...
    description:
      "Designed for runners and outdoor use, with cushioned support and breathable mesh. Also suited for casual trail use.",
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <nav className="text-sm text-gray-500 text-right mb-8">
          <span>Shoes</span> / <h2 className="text-gray-900 inline text-sm font-normal">{product.name}</h2>
        </nav>
